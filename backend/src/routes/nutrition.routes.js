...
import { addMeal, analysMeals, deleteMeal, getMealsByDate, getSingleMeal } from "../controller/nutrition.controller.js";
...
router.post("/analys",jwtVerification,analysMeals)
